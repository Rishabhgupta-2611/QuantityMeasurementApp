...
public class QuantityMeasurementApp {
	...
	public static void main(String[] args) {
		...
		demonstrateLengthConversion(30, Length.LengthUnit.CENTIMETERS, Length.LengthUnit.FEET);

		// Demonstrate Conversion from Yards to Inches
		demonstrateLengthConversion(500, LengthUnit.YARDS, LengthUnit.INCHES);
		...
		demonstrateLengthAddition(new Length(100.0, Length.LengthUnit.CENTIMETERS),
				new Length(1.0, Length.LengthUnit.FEET));

		// Same unit addition
		demonstrateLengthAddition(new Length(5.0, Length.LengthUnit.FEET), new Length(3.0, Length.LengthUnit.FEET));
		...
		demonstrateLengthAddition(new Length(1.0, LengthUnit.YARDS), new Length(3.0, LengthUnit.FEET), LengthUnit.FEET);

		// 100 cm + 1 foot = result in Inches
		demonstrateLengthAddition(new Length(100.0, LengthUnit.CENTIMETERS), new Length(1.0, LengthUnit.FEET),
				LengthUnit.INCHES);
