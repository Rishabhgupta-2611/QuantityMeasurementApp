...
public class QuantityMeasurementDatabaseRepository implements IQuantityMeasurementRepository {
	...
	private void createTableIfNotExists() {
		...
		String sql = "CREATE TABLE IF NOT EXISTS quantity_measurements (" + "id INT AUTO_INCREMENT PRIMARY KEY, "
				+ "operation VARCHAR(50), " + "operand1 DOUBLE, " + "operand2 DOUBLE, " + "result DOUBLE" + ")";
	...
	public List<QuantityMeasurementEntity> findAll() {
		...
		try (Connection conn = pool.getConnection();
			...
			while (rs.next()) {
				...
				QuantityMeasurementEntity entity = new QuantityMeasurementEntity(rs.getString("operation"),
						rs.getDouble("operand1"), rs.getDouble("operand2"), rs.getDouble("result"));
