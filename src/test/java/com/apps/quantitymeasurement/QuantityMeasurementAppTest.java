...
public class QuantityMeasurementAppTest {
	...
	void testQuantityMeasurementApp_SimplifiedDemonstration_Conversion() {
		...
		Quantity<WeightUnit> result = QuantityMeasurementApp.demonstrateConversion(q, WeightUnit.GRAM);
	...
	void testQuantityMeasurementApp_SimplifiedDemonstration_Addition() {
		...
		Quantity<WeightUnit> result = QuantityMeasurementApp.demonstrateAddition(q1, q2, WeightUnit.KILOGRAM);
